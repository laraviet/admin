...
namespace Laraviet\Admin\Controllers;

use Illuminate\Database\Eloquent\ModelNotFoundException;
use Illuminate\Support\Facades\App;
use Illuminate\Support\Facades\Input;
use Illuminate\Support\Str;
use Laraviet\Admin\Uploader\ImageUploader;
use Laraviet\Admin\Validation\Article\Create;
use Laraviet\Admin\Validation\Article\Update;
...
class ArticlesController extends BaseController
{
    ...
    {
        if (isOnPages()) {
            $repository = 'Laraviet\Admin\Repositories\Pages\PageRepository';
        } else {
            $repository = 'Laraviet\Admin\Repositories\Articles\ArticleRepository';
        }
