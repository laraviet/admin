...
use Laraviet\Admin\Entities\Option;
...
if (!function_exists('style')) {
    ...
    {
        return HTML::style('packages/laraviet/admin/'.$url, $attributes, $secure);
    }
}
...
if (!function_exists('admin_asset')) {
    ...
    {
        return asset('packages/laraviet/admin/'.$url, $secure);
    }
}
...
if (!function_exists('script')) {
    ...
    {
        return HTML::script('packages/laraviet/admin/'.$url, $attributes, $secure);
    }
}
...
if (!function_exists('article')) {
    ...
    function article()
    {
        return new Laraviet\Admin\Entities\Article();
    }
}
