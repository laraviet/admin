...
class AdminServiceProvider extends ServiceProvider
{
    ...
    protected $providers = [
        ...
        'Laraviet\Admin\Providers\ConsoleServiceProvider',
        'Laraviet\Admin\Providers\RepositoriesServiceProvider',
    ];
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__.'/../../../public/' => public_path('packages/laraviet/admin/'),
        ], 'assets');

        $viewPath = base_path('resources/views/vendor/laraviet/admin/');
